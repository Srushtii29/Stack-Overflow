...
const Auth = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    if(!email && !password){
      alert("Enter an email and password to continue")
    }
    if(isSignup){
      if(!name){
          ...
          <form onSubmit={handleSubmit}>
            ...
            <label htmlFor="password">
              ...
              { isSignup && <p style={{color:"#666767", fontSize:"13px"}}>
                Passwords must contain at least eight<br/>characters, including at least 1 letter<br/>and 1 number.</p>}
            </label>
            {
              isSignup && (
                <label htmlFor="check">
                    <input type='checkbox' id='check' className='checkbox'/>
                      ...
                      updates, user research invitations,<br/>company
